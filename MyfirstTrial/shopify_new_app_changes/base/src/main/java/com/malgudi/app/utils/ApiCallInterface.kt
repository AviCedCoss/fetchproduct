...
import com.malgudi.app.utils.Urls.Data.ALIREVIEW_INSTALLSTATUS
import com.malgudi.app.utils.Urls.Data.ALIREVIEW_PRODUCT
import com.malgudi.app.utils.Urls.Data.EARNREWARD
import com.malgudi.app.utils.Urls.Data.GETREWARDS
import com.malgudi.app.utils.Urls.Data.JUDGEME_GETPRODUCTID
import com.malgudi.app.utils.Urls.Data.JUDGEME_REVIEWCOUNT
import com.malgudi.app.utils.Urls.Data.JUDGEME_REVIEWCREATE
import com.malgudi.app.utils.Urls.Data.JUDGEME_REVIEWINDEX
import com.malgudi.app.utils.Urls.Data.MYREWARDS
import com.malgudi.app.utils.Urls.Data.REDEEMPOINTS
import com.malgudi.app.utils.Urls.Data.SENDREFERRAL
import com.malgudi.app.utils.Urls.Data.SIZECHART
import com.malgudi.app.utils.Urls.Data.YOTPOAUTHENTICATE
import com.malgudi.app.utils.Urls.Data.YOTPOCREATEREVIEW
...
interface ApiCallInterface {
    ...
    fun getRecommendations(@Header("X-SHOP") shop: String, @Header("X-CLIENT") client: String, @Header("X-ACCESS-TOKEN") token: String, @Header("Content-Type") content_tyepe: String, @Body body: com.malgudi.app.dependecyinjection.Body): Single<JsonElement>
