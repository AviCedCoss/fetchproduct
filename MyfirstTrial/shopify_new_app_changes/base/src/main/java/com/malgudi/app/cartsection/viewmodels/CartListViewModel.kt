package com.malgudi.app.cartsection.viewmodels
...
import com.malgudi.app.cartsection.models.CartListItem
...
import com.malgudi.app.shopifyqueries.Mutation
    ...
    fun fillDeliveryParam(edges: List<Storefront.CheckoutLineItemEdge>): HashMap<String, String> {
        ...
        for (i in 0..edges.size - 1) {
            ...
            param.put(
                ...
                String(
                    Base64.decode(
                        edges[i].node.variant.id.toString(),
                        Base64.DEFAULT
                    )
