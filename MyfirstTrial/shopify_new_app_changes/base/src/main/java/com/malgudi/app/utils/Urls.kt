...
class Urls {
    ...
    val shopdomain: String
        get() {
            var domain = "malgudi-your-online-fruit-vegetables-specialist.myshopify.com" //magenative-store.myshopify.com
            try {
    ...
    val apikey: String
        get() {
            var key = "08a0dae746bbe37e55e60af688474289" //63893d2330e639632e2eab540e9d2d75
            try {
                val executor = Executors.newSingleThreadExecutor()
                val callable = Callable {
                    if (repository.getPreviewData().size > 0) {
