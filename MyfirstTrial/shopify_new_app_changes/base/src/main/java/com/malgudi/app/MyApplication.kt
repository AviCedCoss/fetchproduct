...
import com.malgudi.app.dependecyinjection.MageNativeAppComponent
import com.malgudi.app.dependecyinjection.DaggerMageNativeAppComponent
import com.malgudi.app.dependecyinjection.UtilsModule
...
class MyApplication : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        context = this
        mageNativeAppComponent =
            DaggerMageNativeAppComponent.builder().utilsModule(UtilsModule(this)).build()
